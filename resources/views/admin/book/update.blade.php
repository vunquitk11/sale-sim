    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Sửa Post category</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <p class="edit-title">Sửa Post category</p>
                </div>
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" method="POST"  enctype="multipart/form-data" action="">
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-info form-submit-btn">Sửa Post category</button>
                        </div>   
                    </form>
                    @endif
                </div>
