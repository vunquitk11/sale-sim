                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" method="POST"  enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group align-center-row">
                            ...
                            <div class="col-md-9 col-lg-10">
                                <input type="text" name="title" class="form-control" required value="{{$result->title ? $result->title : 'Underfined'}}">
                            </div>
                        </div>
                        <div class="form-group align-center-row">
                                ...
                                @if(isset($categories))
                                    <select class="select2_demo_1 form-control" name="category_id" required>
                                        ...
                                        @foreach($categories as $category)
                                             <option {{$result->category_id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name ? $category->name : 'null'}}</option>
                                        @endforeach
                                    </select>
                                @endif
                            </div>
                        ...
                        <div class="form-group align-center-row">
                            ...
                            <div class="col-md-9 col-lg-10">
                                <textarea class="summernote" id="content" name="content">{!!$result->content ? $result->content : 'Underfined'!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group align-center-row">
                            <label class="col-md-3 col-lg-2 control-label">Thứ tự hiển thị: </label>
                            <div class="col-md-3 col-lg-2">
                                <input type="number" name="position" class="form-control" required value="{{$result->position ? $result->position : 'Underfined'}}">
                            </div>
                        </div>
                        <div class="form-group align-center-row">
