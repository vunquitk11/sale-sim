                ...
                <div class="ibox-content">
                    <form class="form-horizontal" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="name" class="form-control" id="name" value="{{$role->name ? $role->name : 'Underfined'}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row-alt col-12 col-lg-6">
                                Thiết lập quyền hạn:
                            </div>
                        </div>
                        ...
                        <div class="form-footer">
                            <button class="form-submit-btn btn btn-info" type="submit" class="btn btn-primary pull-right col-lg-2" id="upload-video-button">Sửa nhóm quyền</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        var details = detail_array.split(",");
        for(var i=0;i < details.length; i++){
            $('#'+details[i]).prop('checked',true);
        }
